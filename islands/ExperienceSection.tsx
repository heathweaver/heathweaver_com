...
export default function ExperienceSection(
  ...
  const handleRemoveArrayItem = (
    ...
    if (!editState) return;
    const newArray = (editState.currentData[field] || []).filter((_, i) =>
      i !== index
    );
    handleFieldChange(field, newArray);
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      for (const field of fields) {
        ...
        if (
          (field === "responsibilities" || field === "achievements") &&
          (!editState.currentData[field] ||
            editState.currentData[field]?.length === 0)
        ) {
          continue;
        }
        ...
        if (field === "responsibilities" || field === "achievements") {
          value = (value as string[])?.filter((item) => item.trim() !== "") ||
            null;
        }
        ...
        if (!response.ok) {
          ...
          throw new Error(
            `Failed to update ${field}: ${errorData.error || "Unknown error"}`,
          );
        }
      }
                  ...
                  <div class="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleFieldChange("company", e.currentTarget.value)}
                        onKeyDown={handleKeyDown}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleFieldChange("location", e.currentTarget.value)}
                        onKeyDown={handleKeyDown}
                        class="w-full p-1 border rounded mt-1"
                        disabled={isSaving}
                      />
                    ...
                    <div class="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          value={formatDateForInput(
                            editState.currentData.start_date,
                          )}
                          onChange={(e) =>
                            handleFieldChange(
                              "start_date",
                      ...
                      <div>
                        ...
                        <input
                          type="date"
                          value={formatDateForInput(
                            editState.currentData.end_date,
                          )}
                          onChange={(e) =>
                            handleFieldChange(
                              "end_date",
                    ...
                    <div>
                      ...
                      <div class="space-y-2 mt-1">
                        {(editState.currentData.responsibilities || []).map((
                          resp,
                          index,
                        ) => (
                    ...
                    <div>
                      ...
                      <div class="space-y-2 mt-1">
                        {(editState.currentData.achievements || []).map((
                          achievement,
                          index,
                        ) => (
                          <div key={index} class="flex gap-2">
                            ...
                            <button
                              onClick={() =>
                                handleRemoveArrayItem("achievements", index)}
                              disabled={isSaving}
                              class="px-2 py-1 text-red-600 hover:text-red-800"
                            >
                              ×
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          handleFieldChange("narrative", e.currentTarget.value)}
                        onKeyDown={handleKeyDown}
                      ...
                      (
                        <ul class="mt-2 list-disc list-inside">
                          {exp.responsibilities.map((resp, i) => (
                            <li key={i} class="text-sm text-gray-600">
                              {resp}
                            </li>
                          ))}
                        </ul>
