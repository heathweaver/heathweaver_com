...
export default function SignUpPage(props: PageProps) {
  const renderStars = () => (
    <div class="flex items-center mb-4">
      ...
      <span class="ml-2 text-sm text-gray-600">5.0 from over 100 runners</span>
    </div>
  );
    ...
    <div class="min-h-screen bg-[#fff9e5] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div class="ml-[100px] max-w-md">
        <div class="space-y-6">
          ...
          <form class="space-y-6" action="/auth/api/login-magic" method="POST">
            <div>
