      ...
      <div class="ml-[100px] max-w-md">
        <div class="space-y-6">
          ...
          <p class="text-xl text-gray-600 mb-6">
            Complete sign up through the email we sent to your email address, or
            choose a different option below.
          </p>
          ...
          <div class="p-4 bg-white rounded-lg border border-gray-200">
            <label class="flex items-center">
              ...
              <span class="ml-2">
                ...
                <a href="/terms" class="font-medium text-black hover:underline">
                  Terms of Service
                </a>{" "}
                and{" "}
                <a
