...
import { getUserProfile, formatEducationDisplay } from "../lib/db/user-db.ts";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Manage your AI CV Generator profile and settings" />
      </Head>
            ...
            <div class="bg-white shadow rounded-lg p-6">
              <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center space-x-4">
                  <span class="text-sm text-gray-500">Credits: {data.user.credits}</span>
                </div>
              </div>
              ...
              <div class="pt-6">
                <h2 class="text-lg font-medium text-gray-900 mb-4">Professional Experience</h2>
                <ExperienceSection experiences={data.profile?.experience || []} />
              </div>
                ...
                <div id="skills-list" class="space-y-4">
                  {data.profile?.skills?.map((skill) => (
                    <div key={skill.id} class="border rounded-lg p-4">
                      <h3 class="font-medium text-gray-900">{skill.category}</h3>
                      <div class="mt-2 flex flex-wrap gap-2">
                        {skill.skills.map((skillName, i) => (
                          <span key={i} class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                            {skillName}
                          </span>
                        ))}
                      </div>
              ...
              <div class="pt-6">
                <h2 class="text-lg font-medium text-gray-900 mb-4">Awards & Certifications</h2>
